define("p3/widget/GenomeContainer", [
	...
	"./PathwaysGridContainer", "dijit/layout/ContentPane","dijit/TooltipDialog",
	"./FilterContainerActionBar", "./GenomeGridContainer", "./GridContainer","./SequenceGridContainer"
			...
			PathwaysGridContainer, ContentPane, TooltipDialog,
			FilterContainerActionBar,GenomeGridContainer,GridContainer,SequenceGridContainer
){
	...
	return declare([BorderContainer], {
		...
		onFirstView: function(){
			...
			this.filterPanel = new FilterContainerActionBar({region: "top", splitter:true,layoutPriority: 7, style: "height: 48px;", facetFields: this.facetFields, state: this.state,"className": "BrowserHeader",dataModel: "genome"})

			this.genomesGrid = new GenomeGridContainer({title: "Genomes", state: this.state,visible: true,enableFilterPanel: false});

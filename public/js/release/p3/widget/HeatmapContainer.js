define("p3/widget/HeatmapContainer", [
  ...
  return declare([], {
    ...
    initializeFlash: function (domName) {
      ...
      target.innerHTML = "If you don't see heatmap image, you need to enable Adobe flash player. <a href='https://helpx.adobe.com/flash-player.html' target='_blank'>Click here for instructions</a>.";

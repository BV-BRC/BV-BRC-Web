define("p3/widget/SpecialtyGeneGrid", [
	...
	return declare([Grid], {
		...
		columns: {
			...
			classification: {label: "Classification", field: "classification", sortable: false, hidden: true},
			antibiotics_class: {label: "Antibiotics Class", field: "antibiotics_class", hidden: true},
			antibiotics: {label: "Antibiotics", field: "antibiotics", sortable: false, hidden: true},
			pubmed: {label: "Pubmed", field: "pmid", sortable: false, hidden: false},

define("p3/widget/VariantLineageChartContainer", [
  ...
  return declare([BorderContainer], {
    ...
    startup: function () {
      ...
      this.barchart_r.init(this.viewer.domNode, `variant_lineage_chart_${this.state.groupBy}`)
    ...
    processData: function () {
      return when(this.store.query({}), lang.hitch(this, function(data) {
        ...
        return data.map(function(el) {
          ...
          el.name = (groupBy == 'country') ? el.lineage : el.country;

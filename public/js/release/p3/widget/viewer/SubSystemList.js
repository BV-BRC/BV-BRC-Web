define("p3/widget/viewer/SubSystemList", [
	"dojo/_base/declare", "./TabViewerBase", "dojo/on", "dojo/topic",
	"dojo/dom-class", "dijit/layout/ContentPane", "dojo/dom-construct",
	"../PageGrid", "../formatter", "../SubsystemsGridContainer", "../SequenceGridContainer",
	"../../util/PathJoin", "dojo/request", "dojo/_base/lang"
], function(declare, TabViewerBase, on, Topic,
			domClass, ContentPane, domConstruct,
			Grid, formatter, SubSystemsGridContainer, SequenceGridContainer,
			PathJoin, xhr, lang){
		...
		setActivePanelState: function(){
			...
			switch(active){
				case "overview":
					...
					break;
				case "subsystems":
					var search = this.state.search + "&group((field,subsystem_id),(format,simple),(ngroups,true),(limit,1),(facet,true))" +

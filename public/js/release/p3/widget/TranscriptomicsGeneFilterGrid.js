define("p3/widget/TranscriptomicsGeneFilterGrid", [
	...
	return declare([Grid], {
		...
		columns: {
			present: selector({label: '', field: 'present', selectorType: 'radio', unhidable: true}, filterSelector),
			absent: selector({label: '', field: 'absent', selectorType: 'radio', unhidable: true}, filterSelector),
			mixed: selector({label: '', field: 'mixed', selectorType: 'radio', unhidable: true}, filterSelectorChecked),

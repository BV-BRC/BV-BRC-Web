require({cache:{
'url:dgrid/css/columnset.css':{"cssText":".dgrid-column-set{overflow:hidden;width:100%;position:relative;height:100%;}.dgrid-column-set-cell{vertical-align:top;height:100%;}.dgrid-column-set-scroller-container{font-size:0;position:absolute;bottom:0;}.dgrid-autoheight .dgrid-column-set-scroller-container{position:relative;}.dgrid-column-set-scroller{display:inline-block;overflow-x:auto;overflow-y:hidden;}.dgrid-column-set-scroller-content{height:1px;}html.has-mozilla .dgrid-column-set *:focus, html.has-safari .dgrid-column-set *:focus{border:1px dotted black;outline:1px dotted black;}html.has-ie-7 .dgrid-column-set{width:auto;}html.has-quirks .dgrid-column-set{width:100%;}#dgrid-css-columnset-loaded{display:none;}","xCss":"html.has-mozilla .dgrid-column-set *:focus, html.has-safari .dgrid-column-set *\n:focusoutline=;;height=;height=;bottom=;position=;overflow-y=;height=;outline=;width=;width=;display=;"}}});
define("dgrid/ColumnSet", ["dojo/_base/kernel", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/Deferred", "dojo/on", "dojo/aspect", "dojo/query", "dojo/has", "./util/misc", "put-selector/put", "xstyle/has-class", "./Grid", "dojo/_base/sniff", "xstyle/css!./css/columnset.css"],

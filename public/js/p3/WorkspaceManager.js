define([
	...
	var WorkspaceManager = (declare([Stateful], {
		...
		"feature_table", "folder", "genbank_file", "genome",
		"genome_annotation_result", "genome_comparison_table", "genome_group",
		"gff", "gif", "html", "job_result", "jpg", "json", "mapping", "media",
		"model", "modelfolder", "model_edit", "modeltemplate", "nwk", "pdf", "png",
		"ppt", "pptx", "proteomics_experiment", "reads", "rxnprobs", "string",
		"svg", "tar_gz", "tbi", "transcriptomics_experiment", "transcripts", "txt",
		"unspecified", "vcf", "vcf_gz", "wig", "xls", "xlsx", "zip", "contigset"],

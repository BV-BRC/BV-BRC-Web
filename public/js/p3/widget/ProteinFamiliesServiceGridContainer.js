define([
  ...
  // Swaps between the pgfam, plfam, and figfam grids
  // Loads the tables from the workspace and initializes each
  // Use the Topic.subscribe thing to switch grids
  return declare([GridContainer], {
    gridCtor: ProteinFamiliesServiceGrid,
    containerType: 'proteinfamily_data',
    visible: true,
    tutorialLink: 'user_guides/organisms_taxon/protein_families.html',
    pfState: null, // pgfam, plfam, figfam
    loaded: false,

define([
  ...
  'dojo/dom-style', 'dojo/query', 'dojo/dom-attr', 'dojo/aspect', 'dojo/topic',
  './GridSelector', 'put-selector/put',
  './Grid', '../store/ArrangeableMemoryStore'
], function (
  declare, lang, Deferred,
  domStyle, domQuery, domAttr, aspect, Topic,
  selector, put,
  Grid, Store
) {
  ...
  return declare([Grid], {
    ...
    columns: {
      ...
      exp_name: { label: 'Exp Name', field: 'exp_name', hidden: true },
      bioset_id: { label: 'Bioset ID', field: 'bioset_id', hidden: true },
      bioset_name: { label: 'Bioset Name', field: 'bioset_name' },
      bioset_type: { label: 'Type', field: 'bioset_type' },

define([
  ...
  return declare([AppBase], {
    ...
    applicationDescription: 'The Viral Assembly Service utilizes IRMA (Iterative Refinement Meta-Assembler) to assemble viral genomes. Users must select the virus genome for processing. This service is currently in beta, and a tutorial will be available soon.',
    applicationHelp: '',
    tutorialLink: '',
    defaultPath: '',

define([
	...
	return declare([BorderContainer], {
		...
		startup: function(){
			...
			this.viewHeader = new ContentPane({content: "Loading data from "+this.data.name+" job file.  If you have moved your job result, please ensure you have also moved the ."+this.data.name+" folder to this directory as well.", region: "top", style:"width:90%;height:40%;", splitter: true});

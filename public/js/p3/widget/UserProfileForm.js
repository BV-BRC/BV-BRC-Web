  ...
  return declare([WidgetBase, FormMixin, Templated, WidgetsInTemplate], {
    ...
    startup: function () {
      ...
      if (window.App.authorizationToken !== null && window.App.authorizationToken !== undefined) {
        ...
        this.notificationsContainer.innerHTML = 'Click <a href="https://lists.bv-brc.org/mailman/listinfo/all-users" target="_blank">HERE</a> to manage your Cross-BRC Mailing List subscription.'

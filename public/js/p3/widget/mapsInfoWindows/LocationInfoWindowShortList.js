define([
  ...
  'dijit/_TemplatedMixin', 'dojox/dtl/_Templated', 'dojo/text!../templates/SurveillanceDataMapInfoWindowShortList.html'
], function (
  ...
  return declare([WidgetBase, OnDijitClickMixin, Templated, DtlTemplated, _WidgetsInTemplateMixin], {
    ...
    postCreate: function () {
      ...
      on(document, `#sd-zoom-${this.index}:click`, lang.hitch(this, function () {
        ...
        this.map.setView([this.locationLat, this.locationLng], zoomLevel);
      }));
    }
  });
});

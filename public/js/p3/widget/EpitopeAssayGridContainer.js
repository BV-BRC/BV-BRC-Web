define([
  ...
  './EpitopeAssayGrid', './AdvancedSearchFields', './GridContainer',
  '../util/PathJoin'
  ...
  return declare([GridContainer], {
    gridCtor: EpitopeAssayGrid,
    containerType: 'epitope_assay_data',
    tutorialLink: '',
    facetFields: AdvancedSearchFields['epitope_assay'].filter((ff) => ff.facet),
    advancedSearchFields: AdvancedSearchFields['epitope_assay'].filter((ff) => ff.search),
    filter: '',
    dataModel: 'epitope_assay',
    primaryKey: '',
    defaultFilter: '',
    tooltip: 'The “Epitope Assays” tab shows the list of epitope assays associated with the current view.',

    ...
    getSummaryData: function () {
      ...
      if (this.feature.gene_id) {
        ...
        xhr.get(url, xhrOption).then(lang.hitch(this, function (data) {
          ...
          var url = PathJoin(this.apiServiceUrl, 'id_ref/?in(uniprotkb_accession,(' + uniprotKbAccessions + '))&select(uniprotkb_accession,id_type,id_value)&ne(id_type,GI)&ne(id_type,CRC64)&sort(+id_type,+id_value)&limit(25000)');
          xhr.get(url, xhrOption).then(lang.hitch(this, function (data) {
            if (data.length === 0) return;

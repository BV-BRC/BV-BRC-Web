define([
  ...
  'dojox/charting/Chart2D', 'dojox/charting/themes/Distinctive', '../store/VariantLineageChartMemoryStore',
  ...
  return declare([BorderContainer], {
    ...
    startup: function () {
      ...
      console.log('VariantChartContainer startup(), tgState', this.tgState);
